...
/* $ModDesc: Adds SNOMasks u, U, v and V for user and channel mode changes */
...
public:
	...
	Version GetVersion()
	{
		return Version("Adds snomasks u and U with notices of users changing modes - synmuffin", VF_COMMON);
	}
